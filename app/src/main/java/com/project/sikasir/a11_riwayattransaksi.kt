...
class a11_riwayattransaksi : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_a11_riwayattransaksi)
        ...
        navigation_rv.addOnItemTouchListener(RecyclerTouchListener(this, object : ClickListener {
            override fun onClick(view: View, position: Int) {
                when (position) {
                    0 -> {
                        val intent = Intent(this@a11_riwayattransaksi, a2_menu::class.java)
                        intent.putExtra("activityName", "Beranda")
                        startActivity(intent)
                        finish()
                    }
                    1 -> {
                        val intent = Intent(this@a11_riwayattransaksi, a3_kelolaproduk::class.java)
                        intent.putExtra("activityName", "Kelola Produk")
                        startActivity(intent)
                    }
                    2 -> {
                        val intent = Intent(this@a11_riwayattransaksi, a6_transaksi::class.java)
                    ...
                    3 -> {
                        val intent =
                            Intent(this@a11_riwayattransaksi, a11_riwayattransaksi::class.java)
                        intent.putExtra("activityName", "Riwayat Transaksi")
                        startActivity(intent)
                        finish()
                    }
                    4 -> {
                        val intent = Intent(this@a11_riwayattransaksi, a5_kelolapegawai::class.java)
                        intent.putExtra("activityName", "Kelola Pegawai")
                        startActivity(intent)
                    }
                    5 -> {
                        val intent = Intent(this@a11_riwayattransaksi, a10_laporan::class.java)
                        intent.putExtra("activityName", "Laporan")
                        startActivity(intent)
                        finish()
                    }
                    6 -> {
                        val intent = Intent(this@a11_riwayattransaksi, a14_pengaturan::class.java)
                        intent.putExtra("activityName", "Pengaturan")
                        startActivity(intent)
                        finish()
                    }
                    7 -> {
                        val intent = Intent(this@a11_riwayattransaksi, a15_about::class.java)
